...
export function FeaturesSection() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-6xl px-6 py-28 sm:py-36">
      <motion.h2
      ...
      <motion.p
        initial={{ opacity: 0, y: 12 }}
        animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 12 }}
        transition={{ delay: 0.05, duration: 0.7, ease: [0.25, 0.1, 0.25, 1] }}
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {features.map((feature, i) => (
          <motion.div
            ...
            className={`group relative overflow-hidden rounded-2xl border p-7 transition-shadow hover:shadow-lg ${
              feature.highlight
